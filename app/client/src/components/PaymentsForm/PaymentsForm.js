...
const PaymentsForm = props => {
    ...
    const getRemainingBalance = () => {
        return props.data && (props.data?.total_incl_vat - (props.data?.payments.map(item => item.amount).reduce((a, b) => a + b, 0))).toFixed(2);
    };
        ...
        },
        {
            ...
            dropdownOptions: {
                ...
                menuEntries: [
                    ...
                    <MenuItem value={"Contra"} key={"Contra"}>Contra</MenuItem>,
                ]
            }
        },
        {
